  ...
  <div class="wrap">
    <div class="left">
      <div class="panel">
        ...
        <h1>Crear cuenta</h1>
        <div class="muted">Regístrate para solicitar acceso. El administrador aprobará tu cuenta.</div>
        ...
        <form method="POST" action="{{ route('register.post') }}">
          ...
          <button class="btn" type="submit" style="margin-top:12px;">Registrarme</button>
        </form>
